...
app.get('/news-api/v1/categorias/:categoriaId/noticias', (req, res) => {
    ...
    connection.query('SELECT id_categoria, titulo FROM sistema_noticias.noticia WHERE id_categoria = ' + req.params.categoriaId, function (err, rows, fields) {
        if (err) throw err
